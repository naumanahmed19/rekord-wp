...
<?php
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'rekord' ), strip_tags( $args['product_name'] ) ) : '';
	?>
<div class="quantity">
    <span class="xv-qyt xv-qup" data-value="1">+</span><span class="xv-qyt xv-down" data-value="-1">-</span>
    <label class="screen-reader-text"
        for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'rekord' ); ?></label>
    <input type="number" id="<?php echo esc_attr( $input_id ); ?>" class="input-text qty text"
        ...
        title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'rekord' ); ?>" size="4"
